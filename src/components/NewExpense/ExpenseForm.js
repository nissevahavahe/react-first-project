    ...
    return (
            <form onSubmit={submitHandler}>
                <div className='new-expense__controls'>
                    ...
                    <div className='new-expense__control'>
                        <label>Date</label>
                        <input type='date' min='2022-01-01' max='2024-12-31' onChange={dateChangeHandler} value={enteredDate}></input>
                    </div>
                </div>
                <div className='new-expense__actions'>
                    <button type='submit' onClick={props.isHidden}>Cancel</button>
